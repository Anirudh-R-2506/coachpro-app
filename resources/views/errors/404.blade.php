    ...
    <body>
        ...
        <div class="flex flex-row items-center justify-center h-screen p-10">
            <div class="flex flex-col items-center justify-center w-1/2">
                ...
                <p class="mb-5 text-center text-gray-800" style="font-size: 1.5rem;" data-aos="fade-zoom-right" data-aos-delay="200">Looks like you've found the doorway to nothingness</p>
            ...
            <div class="flex items-center justify-center w-1/2">                
                <lottie-player src="{{asset('images/errors/404.json')}}" background="transparent"
                        speed="1" style="width: 80%; height: 80%;" data-aos="fade-zoom-in" data-aos-delay="100" loop autoplay></lottie-player>    
            </div>
        </div>
