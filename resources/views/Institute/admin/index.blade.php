...
<div class="p-0 container-fluid">
    ...
    <h1 class="mb-3 h3"><strong>Dashboard</strong></h1>
    <div class="mb-2 row">
        <div class="col-6" style="width: fit-content !important;">
            <h3>Show stats for</h3>
        </div>
        <div class="col-6">
            <select class="mb-2 form-control" id="stats-select" style="width: 50%;margin-left: -15px;">
    ...
    <div class="row">
        ...
        {{-- <div class="col-md-6">
            <div class="card flex-fill w-100">
                ...
                <div class="py-3 card-body" style="height: 275px;">
                    <form action="#">
        ...
        <div class="col-md-8 d-flex order-xxl-2">
            <div class="card flex-fill w-100">
                <div class="card-header">
                    ...
                    <h5 class="mb-0 card-title">Donations received per month</h5>
                </div>
        ...
        <div class="col-md-4 d-flex order-xxl-3">
            <div class="card flex-fill w-100">
                <div class="card-header">
                    ...
                    <h5 class="mb-0 card-title">Procurement Orders per location</h5>
                </div>
