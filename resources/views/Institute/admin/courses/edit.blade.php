                ...
                <form id="course_create_form" x-data="create_course" x-init="mounted">
                    ...
                    <div class="card-body">
                            ...
                            <div class="mb-5 row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" id="total_fee" name="total_fee" required value="{{$course->fees}}">
                                </div>
                            </div> 
                            <hr class="my-5">
                            ...
                            <div class="mb-5 row">                                
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="video" id="video" value="{{$course->video_url}}">
                                </div>
                            </div>
                    </div>
